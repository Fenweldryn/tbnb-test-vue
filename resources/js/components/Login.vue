    ...
    <div class="min-h-screen flex flex-col justify-center sm:py-12">
        <div class="p-10 xs:p-0 mx-auto md:w-full md:max-w-md">
            <h1 class="font-bold text-center text-2xl mb-5">TurnoverBnb Test</h1>  
                <div class="text-green-600 bg-white shadow-md rounded-md p-5 mb-5 w-full">
                    <font-awesome-icon icon="exclamation-triangle"/>
                    <span class='text-lg font-bold'>Sistema de login não está completo. Clique no botão login para seguir em frente.</span></i>
                </div>  
